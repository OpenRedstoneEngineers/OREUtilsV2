...
class AliasInfo:
    ...
    def GetTag(self, name):
        return str(self.BraColor) + "[" + str(self.SrvColor) + self.Name + str(self.BraColor) + "]" + str(
            self.NamColor) + name + ": " + str(self.MsgColor)
        ...
        if args[0].startswith('%'):
            ...
            for player in Bukkit.getServer().getOnlinePlayers():
                if player.getName() == reciever:
                    player.sendMessage(str(ChatColor.BLUE) + "[" + str(ChatColor.AQUA) + "IRC " + name + " -> me" + str(
                        ChatColor.BLUE) + "]" + str(ChatColor.WHITE) + " " + " ".join(args[1:]))
        ...
        if alias.IsServer:
            ...
            if args[0].startswith('%'):
                ...
                for player in Bukkit.getServer().getOnlinePlayers():
                    if player.getName() == reciever:
                        player.sendMessage(
                            str(ChatColor.BLUE) + "[" + str(ChatColor.AQUA) + "IRC " + name + " -> me" + str(
                                ChatColor.BLUE) + "]" + str(ChatColor.WHITE) + " " + " ".join(args[1:]))
            else:
